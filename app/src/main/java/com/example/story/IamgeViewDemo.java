...
public class IamgeViewDemo extends AppCompatImageView {

    Button button_2;
    public IamgeViewDemo(@NonNull Context context) {
        super(context);
    }

    public IamgeViewDemo(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public IamgeViewDemo(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
